data = [
  {
    ...
    description:
      "New Balance CK4040 L4 Cricket Shoes SpikesThe New Balance 4040 bowler's spike 2020 edition continues to evolve as NB works together with some of the fastest bowlers in the world to develop and improve the performance a little more every time. In its fourth iteration, this 4040 L4 is lighter and more flexible and supportive than its predecessors without losing any of its durability or style. The leather and synthetic mesh upper is made tough enough to stand up to any competition, and the REVlite midsole has an integrated medial post for unbelievably lightweight, responsive cushioning and support from the first over of the day to the last.A skeletally engineered upper that provides ultralight support and fit. Created by fusing two thin materials with a no-sew process.An innovative foam compound providing the same responsiveness and durability of New Balance foams 30% heavier. REVlite offers a lightweight ride without minimizing construction or sacrificing underfoot cushioning or stability.Fitted bootie construction, to sit just below the ankle boneAdditional foam padding around the ankleMidsole density now softer than previous modelsRevised outsole and spike configuration",
  },
  {
  ...
  },
  {
    ...
    description:
      "Puma 19 FH Rubber Cricket Shoes - Virat Kohli Shoes IPL 2019The Puma 19 FH Rubber is a multifunctional performance cricket shoe engineered for sports on grass and hard natural surfaces.- The Lightweight synthetic upper delivers comfort, breathability, and a fresh look.- The internal Support structure and a reinforced toe cap provide necessary stability and durability.- The Multi-studded rubber outsole ensures excellent grip, while the lightweight EVA foam midsole provides optimal cushioning.- This Cricket shoes will be worn by Virat Kohli in the upcoming IPL 2019.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Nike Domain 2 Cricket ShoesThe Nike Domain 2 Unisex Cricket Shoes delivers lightweight cushioning and superb grip on the field with a Phylon midsole and aggressive traction pattern. If you are buying Nike Cricket shoes online then these are the best spike cricket shoes. On sportsuncle you will get the genuine products and not counterfeit products.BenefitsSynthetic leather upper for flexible comfortPhylon midsole for lightweight cushioningDurable full-length plate with 11 metal studs for superb tractionMade in Vietnam",
  },
  {
  ...
  },
  {
    ...
    description:
      "Puma 19 FH Rubber Cricket Shoes - Virat Kohli Shoes WorldCup 2019The Puma 19 FH Rubber is a multifunctional performance cricket shoe engineered for sports on the grass and hard natural surfaces. These White Gold Colored shoes wear by Virat Kohli in World Cup 2019- The Lightweight synthetic upper delivers comfort, breathability, and a fresh look.- The internal Support structure and a reinforced toe cap provide necessary stability and durability.- The Multi-studded rubber outsole ensures excellent grip, while the lightweight EVA foam midsole provides optimal cushioning.",
  },
  {
    ...
    description:
      "Kookaburra KCS 2000 Cricket Shoes SpikesDurable combination upper featuring Mesh, PU & Latex providing superb comfort & durabilityKookaburra ‘cage’ technology offering essential mid-foot supportIntegrated padded tongue for improved comfort and fitAthletic style ‘Slip Last’ for comfort & supportThermo-Plastic Heel Counter increases supportPadded Ankle & HeelLightweight insole with heel and front support to reduce shockwavesLow Profile EVA Midsole providing superb shock absorbency & comfortPremium Spike Outsole - Rubber Cleats available separatelyLooking for Kookaburra KCS 1500 Stud Cricket Shoes then buy here.",
  },
];
